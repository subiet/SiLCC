...
tag_table = Table('tag', metadata,
    Column('id', mysql.MSBigInteger(unsigned=True), autoincrement=True,
...
tag_assoc_table = Table('tag_assoc', metadata,
    Column('id', mysql.MSBigInteger(unsigned=True), autoincrement=True, 
                                    primary_key=True, nullable=False),
    Column('tag_one_id', mysql.MSBigInteger(unsigned=True), nullable=False,
                                                                index=True),
    Column('tag_two_id', mysql.MSBigInteger(unsigned=True), nullable=False,
                                                                index=True),
